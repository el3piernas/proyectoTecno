                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <button type="submit" @click="listarPaquete(1,buscar,criterio)" class="btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <tbody>
                            <tr v-for="paquete in arrayPaquete" :key="paquete.id">
                                <td>
                                    ...
                                    <template >
                                       <button type="button" class="btn-danger btn-sm" @click="eliminarPaquete(paquete.id)">
            ...
            <div class="modal-dialog modal-primary modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" v-if="tipoAccion==1" class="btn btn-primary" @click="guardarPaquete()" >Guardar</button>
                        <button type="button" v-if="tipoAccion==2" class="btn btn-primary" @click="actualizarPaquete()" >Actualizar</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
        ...
        methods :{
            ...
            actualizarPaquete(){
                ...
                if (result.value) {
                    ...
                    axios.delete('/paquete/eliminar_' + id,{
                        'id': id
                    }).then(function (response) {
                        me.listarPaquete(1,'','acontecimiento');
                        swal(
            ...
            validarPaquete(){
                ...
                if (!this.acontecimiento) this.errorMostrarMsjpaquete.push("el acontecimiento del Paquete no puede estar vacio.");
